...
public:
   ...
   void deposit(int depositAmount) {
    ...
    // function that subtracts desired withdrawal amount from balance - added by me
    void withdraw(int withdrawAmount) {
        if (withdrawAmount > balance){std::cout << " Withdrawal amount exceeded account balance";}
        else {
